...
def main():
    ...
    parser.add('--rx_sample_rate', type=float, help="Sample rate for RX (Hz). Example: 2e6")
    parser.add('--rx_center_freq', type=float, help="Center frequency for receiver (Hz). Example: 434e6")
    parser.add('--rx_channel_freq', type=float, help="Channel frequency for receiver. Offset from center (Hz). Example: 40000")
