...
def main():
    ...
    parser.add_argument('--tx_sample_rate', type=float, help="Sample rate for TX (Hz). Example: 2e6")
    parser.add_argument('--tx_center_freq', type=float, help="Center frequency for TX (Hz). Example: 434e6")
    parser.add_argument('--tx_channel_freq', type=float, help="Channel frequency for transmitter. Offset from center (Hz). Example: 25000")
    # parser.add_argument('--tx_antenna', type=str, help="")
    parser.add_argument('--tx_gain', type=int, help="Gain for TX. Example: 10")
    
    parser.add_argument('--rx_sample_rate', type=float, help="Sample rate for RX (Hz). Example: 2e6")
    parser.add_argument('--rx_center_freq', type=float, help="Center frequency for receiver (Hz). Example: 434e6")
    parser.add_argument('--rx_channel_freq', type=float, help="Channel frequency for receiver. Offset from center (Hz). Example: 40000")
    # parser.add_argument('--rx_antenna', type=str, help="")
    parser.add_argument('--rx_gain', type=int, help="Gain for RX. Example: 20")
